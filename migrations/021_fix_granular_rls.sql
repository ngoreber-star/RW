...
-- ============================================
-- Drop policies existentes para permitir re-ejecución
-- ============================================
...
DROP POLICY IF EXISTS pos_terminals_select ON pos_terminals;
DROP POLICY IF EXISTS pos_terminals_insert ON pos_terminals;
DROP POLICY IF EXISTS pos_terminals_update ON pos_terminals;
DROP POLICY IF EXISTS pos_terminals_delete ON pos_terminals;
DROP POLICY IF EXISTS pos_terminal_closures_select ON pos_terminal_closures;
DROP POLICY IF EXISTS pos_terminal_closures_insert ON pos_terminal_closures;
DROP POLICY IF EXISTS pos_terminal_closures_update ON pos_terminal_closures;
DROP POLICY IF EXISTS pos_terminal_closures_delete ON pos_terminal_closures;
DROP POLICY IF EXISTS loyalty_cards_select ON loyalty_cards;
DROP POLICY IF EXISTS loyalty_cards_insert ON loyalty_cards;
DROP POLICY IF EXISTS loyalty_cards_update ON loyalty_cards;
DROP POLICY IF EXISTS loyalty_cards_delete ON loyalty_cards;
...
DROP POLICY IF EXISTS crm_coupons_select ON crm_coupons;
DROP POLICY IF EXISTS crm_coupons_insert ON crm_coupons;
DROP POLICY IF EXISTS crm_coupons_update ON crm_coupons;
DROP POLICY IF EXISTS crm_coupons_delete ON crm_coupons;
DROP POLICY IF EXISTS crm_coupon_purchases_select ON crm_coupon_purchases;
DROP POLICY IF EXISTS crm_coupon_purchases_insert ON crm_coupon_purchases;
DROP POLICY IF EXISTS crm_coupon_purchases_update ON crm_coupon_purchases;
DROP POLICY IF EXISTS crm_coupon_purchases_delete ON crm_coupon_purchases;
DROP POLICY IF EXISTS reload_requests_select ON reload_requests;
DROP POLICY IF EXISTS reload_requests_insert ON reload_requests;
DROP POLICY IF EXISTS reload_requests_update ON reload_requests;
DROP POLICY IF EXISTS reload_requests_delete ON reload_requests;
DROP POLICY IF EXISTS discount_campaigns_select ON discount_campaigns;
...
-- También las policies viejas (formato _isolation)
